...
export const QUESTIONS_BY_SUBJECT: QuestionDatabase = {
  ...
  "Português": {
    1: [
      ...
      { q: "Em 'A bela flor perfumou o jardim.', 'bela' é um:", opts: ["Substantivo", "Adjetivo", "Advérbio", "Verbo"], ans: 1, explanation: ["Adjetivo qualifica o substantivo.", "'Bela' qualifica 'flor'.", "Resultado: adjetivo."], mistake: "Confundir adjetivo com advérbio." },
      { q: "Qual é o diminutivo de 'papel'?", opts: ["papelzão", "papeizinho", "papelzinho", "papelinho"], ans: 2, explanation: ["Palavras terminadas em consoante: adiciona-se -zinho.", "papel + zinho = papelzinho.", "Resultado: papelzinho."], mistake: "Usar -inho diretamente: 'papelinho'." },
    ],
    2: [
      ...
      { q: "Em 'Ele falou alto.', a palavra 'alto' é um:", opts: ["Adjetivo", "Substantivo", "Advérbio", "Pronome"], ans: 2, explanation: ["'Alto' modifica o verbo 'falou'.", "Palavra que modifica verbo é advérbio.", "'Alto' = advérbio de modo."], mistake: "Confundir com adjetivo (que qualificaria substantivo)." },
      { q: "Qual a função de 'lhe' em 'Eu lhe dei um presente'?", opts: ["Sujeito", "Obj. Direto", "Obj. Indireto", "Adj. Adnominal"], ans: 2, explanation: ["'Lhe' = pronome oblíquo 3ª pessoa.", "Substitui 'a ele/a ela' — com preposição.", "É Objeto Indireto."], mistake: "Confundir objeto indireto com direto." },
    ],
    3: [
      ...
      { q: "'Quem muito fala, muito erra.' Qual recurso estilístico?", opts: ["Ironia", "Paralelismo", "Eufemismo", "Gradação"], ans: 1, explanation: ["Paralelismo = repetição de estruturas equivalentes.", "'Quem muito fala' // 'muito erra'.", "Recurso: paralelismo sintático."], mistake: "Confundir paralelismo com anáfora." },
      { q: "O que é polissíndeto?", opts: ["Omissão de conjunções", "Repetição excessiva de conjunções", "Inversão da ordem sintática", "Uso de palavras de sentido oposto"], ans: 1, explanation: ["Polissíndeto = repetição de conjunções.", "Ex: 'E chora e ri e canta e dança'.", "O oposto é o assíndeto (omissão)."], mistake: "Confundir polissíndeto com assíndeto." },
    ]
  },
  "Ciências": {
    1: [
      ...
      { q: "O Sol é uma fonte de energia:", opts: ["Eólica", "Solar", "Hídrica", "Nuclear"], ans: 1, explanation: ["Energia do Sol = energia solar.", "É renovável e praticamente inesgotável.", "Eólica=vento; hídrica=água."], mistake: "Confundir energia solar com nuclear." },
      { q: "Qual sistema é responsável pela digestão dos alimentos?", opts: ["Circulatório", "Nervoso", "Digestório", "Respiratório"], ans: 2, explanation: ["O sistema digestório processa os alimentos.", "Inclui boca, estômago, intestinos, etc.", "O respiratório troca gases com o ambiente."], mistake: "Confundir sistema digestório com circulatório." },
    ],
    2: [
      ...
      { q: "O que é biodiversidade?", opts: ["Variedade de minerais", "Variedade de espécies vivas", "Quantidade de água doce", "Extensão de florestas"], ans: 1, explanation: ["Biodiversidade = diversidade biológica.", "Inclui espécies, genes e ecossistemas.", "Brasil é um dos países mais biodiversos."], mistake: "Limitar biodiversidade apenas a animais grandes." },
      { q: "Qual sistema faz a troca de gases nos humanos?", opts: ["Circulatório", "Digestório", "Respiratório", "Excretor"], ans: 2, explanation: ["Sistema respiratório: pulmões, traqueia, brônquios.", "Pulmões trocam O₂ por CO₂.", "Circulatório transporta os gases."], mistake: "Confundir respiratório com circulatório." },
      { q: "O que é a cadeia alimentar?", opts: ["Ciclo de reprodução dos animais", "Sequência de quem come quem num ecossistema", "Sistema digestório dos herbívoros", "Migração dos animais"], ans: 1, explanation: ["Cadeia alimentar = quem come quem.", "Começa nos produtores (plantas).", "Segue por consumidores e decompositores."], mistake: "Confundir cadeia alimentar com ciclo de vida." },
      { q: "O que são fósseis?", opts: ["Rochas vulcânicas", "Restos ou marcas de seres vivos preservados em rochas", "Minerais raros encontrados no solo", "Plantas extintas conservadas em gelo"], ans: 1, explanation: ["Fósseis são restos de organismos preservados.", "Ficam preservados em sedimentos e rochas.", "Ajudam a entender a evolução."], mistake: "Confundir fósseis com minerais ou rochas comuns." },
    ],
    3: [
      ...
      { q: "Qual é a principal causa do efeito estufa intensificado?", opts: ["Desmatamento reduz CO₂", "Emissão de CO₂ e CH₄ por atividades humanas", "Erupções vulcânicas", "Aumento da radiação solar"], ans: 1, explanation: ["Efeito estufa natural é necessário para a vida.", "Queima de combustíveis fósseis aumenta CO₂ e CH₄.", "Isso intensifica o aquecimento global."], mistake: "Confundir efeito estufa natural com o intensificado." },
      { q: "O que é DNA recombinante?", opts: ["DNA danificado", "Combinação de fragmentos de DNA de diferentes organismos", "DNA duplicado na mitose", "DNA sem sequência codificante"], ans: 1, explanation: ["DNA recombinante = produzido em laboratório.", "Combina fragmentos de fontes diferentes.", "Base da engenharia genética."], mistake: "Confundir DNA recombinante com mutação espontânea." },
      { q: "O que é osmose?", opts: ["Transporte ativo de proteínas", "Difusão de solvente por membrana semipermeável", "Absorção de luz pelos cloroplastos", "Síntese de ATP na mitocôndria"], ans: 1, explanation: ["Osmose = difusão da água (solvente).", "Ocorre de região menos concentrada para mais concentrada.", "Atravessa membrana semipermeável."], mistake: "Confundir osmose com difusão simples de solutos." },
    ]
  },
  "História": {
    1: [
      ...
      { q: "O que foi a Revolução Industrial?", opts: ["Revolução política", "Transformação do artesanato em produção fabril", "Guerra entre países", "Criação da internet"], ans: 1, explanation: ["A Rev. Industrial iniciou na Inglaterra no séc. XVIII.", "Substituiu o trabalho manual por máquinas.", "Transformou a economia e a sociedade."], mistake: "Confundir Rev. Industrial com Rev. Francesa." },
      { q: "Qual país colonizou o Brasil?", opts: ["Espanha", "França", "Holanda", "Portugal"], ans: 3, explanation: ["Portugal colonizou o Brasil a partir de 1500.", "A Espanha colonizou a maioria das Américas.", "Por isso o Brasil fala português."], mistake: "Confundir as colônias de Portugal e Espanha." },
      { q: "O que significa 'democracia'?", opts: ["Governo de um só", "Governo dos nobres", "Governo do povo", "Governo militar"], ans: 2, explanation: ["Democracia: demos (povo) + kratos (poder).", "O poder emana do povo.", "Surgiu na Grécia Antiga, em Atenas."], mistake: "Confundir democracia com aristocracia." },
      { q: "O que foi a escravidão no Brasil?", opts: ["Sistema de trabalho voluntário", "Exploração forçada de africanos como mão de obra", "Imigração europeia incentivada", "Trabalho assalariado no campo"], ans: 1, explanation: ["Escravizados africanos foram trazidos à força.", "Eram tratados como propriedade sem direitos.", "O Brasil foi o último país a abolir, em 1888."], mistake: "Confundir trabalho escravo com imigração ou trabalho assalariado." },
    ],
    2: [
      ...
      { q: "O que foi a Revolução Francesa?", opts: ["Rev. industrial inglesa", "Revolta burguesa que derrubou o absolutismo", "Guerra entre França e Alemanha", "Independência dos EUA"], ans: 1, explanation: ["Rev. Francesa (1789) foi liderada pela burguesia.", "Derrubou a monarquia absoluta de Luís XVI.", "Lema: Liberdade, Igualdade e Fraternidade."], mistake: "Confundir Rev. Francesa com Rev. Industrial." },
      { q: "O que foi o Tratado de Tordesilhas (1494)?", opts: ["Acordo de paz após guerra", "Divisão do mundo entre Portugal e Espanha", "Aliança militar", "Proibição da escravidão"], ans: 1, explanation: ["Tordesilhas dividiu o mundo entre as duas potências.", "Linha a 370 léguas a oeste do Cabo Verde.", "Leste→Portugal; Oeste→Espanha."], mistake: "Pensar que era só um acordo comercial." },
      { q: "Qual o principal resultado da II Guerra Mundial?", opts: ["Criação da ONU e início da Guerra Fria", "Independência da África", "Queda do Muro de Berlim", "Criação da UE"], ans: 0, explanation: ["Após 1945, criou-se a ONU para evitar novas guerras.", "EUA e URSS emergiram como superpotências → Guerra Fria.", "O Muro de Berlim caiu em 1989."], mistake: "Colocar a queda do Muro como resultado imediato da WWII." },
      { q: "O que foi a Inconfidência Mineira (1789)?", opts: ["Movimento separatista de São Paulo", "Revolta contra os impostos portugueses liderada por Tiradentes", "Abolição da escravatura em Minas Gerais", "Proclamação da República em Minas"], ans: 1, explanation: ["A Inconfidência foi uma conspiração pela independência.", "Tiradentes foi seu mártir mais famoso.", "Frustrada antes de eclodir; Tiradentes foi enforcado."], mistake: "Confundir com a Proclamação da República (1889)." },
      { q: "O que foi a Guerra do Paraguai (1864-1870)?", opts: ["Conflito entre Brasil e Argentina", "Conflito do Brasil, Argentina e Uruguai contra o Paraguai", "Guerra Civil paraguaia", "Conflito entre Paraguai e Bolívia"], ans: 1, explanation: ["A Tríplice Aliança: Brasil, Argentina e Uruguai.", "Lutaram contra o Paraguai de Solano López.", "Foi a maior guerra na América do Sul."], mistake: "Pensar que foi só Brasil contra Paraguai." },
    ],
    3: [
      ...
      { q: "Qual foi a principal consequência da Crise de 1929 para o Brasil?", opts: ["Desenvolvimento têxtil", "Queda do café e ascensão de Getúlio Vargas", "Industrialização financiada pelos EUA", "Criação da Petrobras"], ans: 1, explanation: ["A crise derrubou o preço do café.", "Enfraqueceu oligarquias → espaço para Vargas.", "Vargas chegou ao poder em 1930."], mistake: "Pensar que industrialização foi financiada pelos EUA." },
